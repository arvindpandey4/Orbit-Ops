...
export default {
  ...
  mongodb: {
    ...
    testUri: process.env.MONGODB_TEST_URI || 'mongodb://localhost:27017/task_management_test',
    options: {
      maxPoolSize: 10,
      minPoolSize: 2,
  ...
  session: {
    presenceTTL: 300, // 5 minutes in seconds
    tokenBlacklistTTL: 900, // 15 minutes in seconds
  },
};
